...
class Database:
    ...
    def migrate(self) -> None:
        with self.connect() as db:
            ...
            for name in ['verify_panel_channel','verify_panel_message','verify_role', *[f'staff_role_{n}' for n in range(1, 11)], 'wipefeed_enabled','wipefeed_channel','urgent_at','urgent_by']:
