...
class Database:
    ...
    def migrate(self) -> None:
        with self.connect() as db:
            ...
            for name in ['verify_panel_channel','verify_panel_message','verify_role', *[f'staff_role_{n}' for n in range(1, 11)], 'wipefeed_enabled','wipefeed_channel','urgent_at','urgent_by','owner_role','moderator_role','admin_role','co_owner_role','head_admin_role']:
    ...
    def upsert_config(self, guild_id, **values: Any):
        allowed={'panel_channel','panel_message','logs_channel','ticket_category','inactivity_hours','welcome_channel','verify_channel','link_channel','bot_commands_channel','shop_channel','verify_panel_channel','verify_panel_message','verify_role','staff_role_1','staff_role_2','staff_role_3','staff_role_4','staff_role_5','staff_role_6','staff_role_7','staff_role_8','staff_role_9','staff_role_10','wipefeed_enabled','wipefeed_channel','owner_role','moderator_role','admin_role','co_owner_role','head_admin_role'}
